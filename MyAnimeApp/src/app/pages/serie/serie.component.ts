...
export class SerieComponent implements OnInit {
  ...
  getCategories(){
    this.service.getCategoriesbytype('2').subscribe((data:any)=>{
      this.categories=data.data;
    })
  }

  getYear(){
    this.service.getCategoriesbyyear('2').subscribe((data:any)=>{
  ...
  this.service.SearchMoviegenderbytype(genero,'2').subscribe((data:any)=>{
    this.file_season=data.data;
    console.log(data);
  ...
  searchYear(year:string){
    this.service.SearchMovieYearbytype(year,'2').subscribe((data:any)=>{
      this.file_season=data.data;
      console.log(data);
    })
  }
  ...
  searhBoth(genero:string, year:string){
    this.service.SearchMovieBothbytype(genero,year,'2').subscribe((data:any)=>{
      this.file_season=data.data;
      console.log(data);
    })
  }
